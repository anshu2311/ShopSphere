...
import { ProductGrid } from "./ProductGrid";
 ...
 price: 120,
 originalPrice: 150,
 description: "This is a stylsidh jacket perfect for every occasion",
 brand: "FashioBarand",
 material: "Leather",
 sizes: ["S","M","L","XL"],
 colors: ["Red","Black"],
...
const ProductDetails = () => {
  ...
  const handleQuantityChange = (action) => {
   if(action === "plus") setQuantity((prev) => Number(prev) + 1);
   if(action === "minus" && quantity > 1) setQuantity((prev) => Number(prev) - 1);
  };
